...
const AdminDashboard = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      const response = await axios.get(
        "https://jokicbt5.vercel.app/api/users/all",
        {
  ...
  const fetchQuestions = async () => {
    ...
    try {
      const response = await axios.get(
        "https://jokicbt5.vercel.app/api/questions/all",
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const handleAddUser = async () => {
    ...
    try {
      const response = await axios.post(
        "https://jokicbt5.vercel.app/api/auth/register",
        newUser,
        {
          headers: {
  ...
  const handleDeleteUser = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://jokicbt5.vercel.app/api/users/${id}`, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const handleSubmitQuestions = async () => {
    ...
    try {
      await axios.post(
        "https://jokicbt5.vercel.app/api/questions/create",
        questionData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDeleteQuestion = async (code) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(
          `https://jokicbt5.vercel.app/api/questions/${code}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
