...
const TokenManagement = () => {
  ...
  const fetchTokens = async () => {
    ...
    try {
      const response = await axios.get(
        "https://jokicbt5.vercel.app/api/access-tokens",
        {
  ...
  const handleSaveToken = async () => {
    ...
    try {
      if (isEditing) {
        ...
        await axios.put(
          `https://jokicbt5.vercel.app/api/access-tokens/update/${currentToken.id}`,
          currentToken,
  ...
  const handleDeleteToken = async (tokenId) => {
    ...
    try {
      await axios.delete(
        `https://jokicbt5.vercel.app/api/access-tokens/delete/${tokenId}`,
        {
          headers: { Authorization: `Bearer ${authToken}` },
        }
      );
